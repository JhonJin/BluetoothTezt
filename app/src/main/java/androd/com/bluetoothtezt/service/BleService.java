package androd.com.bluetoothtezt.service;
...
import androd.com.bluetoothtezt.DeviceConnect;
...
public class BleService extends Service {
    ...
    @SuppressLint("NewApi")
    public BluetoothGattCallback mBluetoothGattCallback = new BluetoothGattCallback() {//蓝牙回调方法
        ...
        @Override
        public void onReadRemoteRssi(BluetoothGatt gatt, int rssi, int status) {//获取蓝牙信号
...
//        mIntent.putExtra("time", DateUtil.getCurrentDatatime());
    ...
    private void broadcastUpdate(String action,
        ...
        if (data != null && data.length > 0) {
            ...
            intent.putExtra(EXTRA_DATA, notify_result);//notify_result存放数据
